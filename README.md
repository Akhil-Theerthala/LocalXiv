# arXiv Paper to Kindle

A small macOS Chrome extension that downloads an arXiv paper's source, converts it to a reflowable EPUB with Pandoc, validates its reading order and local links, and sends it through the configured Mail app to your Kindle.
...
1. Open a paper at `https://arxiv.org/abs/XXXX.YYYYY`.
2. Open the extension.
3. Enter your Send-to-Kindle address on first use. Chrome stores it locally for later sends.
